...
const EVENTS = [
  {
    ...
    prompt: "23:20，玻璃門被撞開。一個醉漢晃進來，說要一間房，什麼房都好。你翻開登記簿——沒有他的名字。",
    choices: [
  ...
  },
  {
    ...
    prompt: "23:50，一個背行李的男人靠在櫃台前：「請問……4 樓怎麼走？」",
    choices: [
  ...
  },
  {
    ...
    prompt: "00:30，大門外站著一個人影，在敲門。玻璃上有霧，你看不清他穿什麼。午夜已經過了。",
    choices: [
      { id: "stay", label: "坐著不動",
  ...
  },
  {
    ...
    prompt: "01:15，櫃台電話響。一聲。兩聲。螢幕上沒有號碼。",
    choices: [
      { id: "answer", label: "接起來",
  ...
  },
  {
    ...
    prompt: "02:40，你例行掃過監視器。大門外的畫面裡，站著一個人。不動，面對大門。你想起交班簿上那條：正常現象，不要看超過十秒。",
  ...
  },
  {
    ...
    prompt: "03:30，電梯門開了——你沒聽見它運轉的聲音。一個男人走到櫃台前，自稱 704 的客人，聲音壓得很低：「隔壁房間在學我說話。」",
    choices: [
  ...
  },
  {
    ...
    prompt: "05:00，大門開了。一個穿本館制服的人走進來，胸口的名牌你沒見過：「辛苦了，我來接班。」守則說 06:00 下班。交班簿說，穿制服的也不能開——可是他已經進來了。",
    choices: [
...
const ENDINGS = [
  ...
  { id: "left-early", label: "提早下班",
    ...
    text: "你不記得你走到了哪。你記得最後一件事，是那串鑰匙離開你手心的重量。隔天，交班簿上多了一行字，字跡是你的：「05:00 來接班的那個，笑起來很標準。」第一晚，提前結束了。" },
